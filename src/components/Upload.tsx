...
export function Upload({ filename = null, ...rest }: Props) {
  return (
    <div>
      ...
      <div className="w-full h-12 flex items-center rounded-lg border border-gray-300 text-sm text-gray-100 outline-none">
        <input type="file" id="upload" className="hidden" {...rest} />

        <span className="text-xs text-gray-100 flex flex-1 pl-4">
